...
<head>
    ...
    <style>
        .crud-form { max-width: 500px; margin: 30px auto; background: #fff; padding: 20px; border-radius: 8px; box-shadow: 0 2px 8px rgb(0 0 0 / 0.1); }
        .crud-form input, .crud-form textarea { width: 100%; margin-bottom: 10px; padding: 8px; }
...
<div class="crud-form">
    ...
    <form method="post">
        ...
        <?php if ($editando): ?>
            <a href="articulos.php" style="display:inline-block;margin-top:10px;">Cancelar</a>
        <?php endif; ?>
    </form>
</div>
